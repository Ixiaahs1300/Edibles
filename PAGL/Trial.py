...
emitter1.set_speed([150.0, 200.0])
...
# Make an occluder
points1 = [[screen_size[0] // 2 - 50, screen_size[1] - 50], [screen_size[0] // 2 + 50, screen_size[1] - 50],
